...
<br>
	<div align=center>
			{include file="SetMenu.tpl"}
				...
				<tr>
					<td width=50 rowspan=2 valign=top><img src="{'system.gif'|@vtiger_imageurl:$THEME}" alt="{$MOD.LBL_USERS}" width="48" height="48" border=0 title="{$MOD.LBL_USERS}"></td>
				...
				<tr>
					<td valign=top class="small">{$MOD.LBL_SYSTEM_DESCRIPTION}</td>
				</tr>
				</table>
