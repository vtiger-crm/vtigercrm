...
<a href="index.php?module=Users&action=ListFldProfiles&fld_module=Accounts">{$MOD.LBL_ACCOUNT_FIELD_ACCESS}</a></td></tr><tr><td>
<a href="index.php?module=Users&action=ListFldProfiles&fld_module=Contacts">{$MOD.LBL_CONTACT_FIELD_ACCESS}</a></td><td>
...
<a href="index.php?module=Users&action=ListFldProfiles&fld_module=Quotes">{$MOD.LBL_QUOTE_FIELD_ACCESS}</a></td><td>
<a href="index.php?module=Users&action=ListFldProfiles&fld_module=Orders">{$MOD.LBL_PO_FIELD_ACCESS}</a></td></tr><tr><td>
<a href="index.php?module=Users&action=ListFldProfiles&fld_module=SalesOrder">{$MOD.LBL_SO_FIELD_ACCESS}</a></td><td>
<a href="index.php?module=Users&action=ListFldProfiles&fld_module=Invoice">{$MOD.LBL_INVOICE_FIELD_ACCESS}</a></td></tr>
</table>
</td>
</tr>
</table>
